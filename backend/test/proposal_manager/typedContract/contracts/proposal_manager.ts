...
import ABI from '../../artifacts/proposal_manager.json';
import QueryMethods from '../query/proposal_manager';
import BuildExtrinsicMethods from '../build-extrinsic/proposal_manager';
import TxSignAndSendMethods from '../tx-sign-and-send/proposal_manager';
import MixedMethods from '../mixed-methods/proposal_manager';
import EventsClass from '../events/proposal_manager';
